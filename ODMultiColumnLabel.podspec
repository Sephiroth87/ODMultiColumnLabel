Pod::Spec.new do |s|
  ...
  s.version  = '1.0'
  s.license  = 'MIT'
  s.summary  = "A UILabel replacement that renders text on multiple columns, comes in both Objective-C and Swift versions"
  ...
  s.description = 'ODMultiColumnLabel is a UILabel replacement that renders text on multiple columns,' \
                  'without any major hassle, available in both Objective-C and Swift'
  s.platform    = :ios
